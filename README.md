# sfmlProject_Pong
A cross-platform [SFML](https://www.sfml-dev.org) 2.5.1 & C++17 build environment for [Visual Studio Code](https://code.visualstudio.com/).  Attempt to code a 2D game (called Pong based on the actual Pong game) using C++ and sfml.
...
1. Open the **sfmlProject_Pong** folder in VS Code. You should see an lime-green status bar at the bottom (color-picked from the SFML logo).
